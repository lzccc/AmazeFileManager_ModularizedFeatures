...
import com.amaze.filemanagerZichongTest.debug.LowStorageService;
...
import com.amaze.filemanagerZichongTest.activities.superclasses.PermissionsActivity;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.CloudLoaderAsyncTask;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.DeleteTask;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.MoveFiles;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.PrepareCopyTask;
import com.amaze.filemanagerZichongTest.asynchronous.services.CopyService;
import com.amaze.filemanagerZichongTest.database.CloudContract;
import com.amaze.filemanagerZichongTest.database.CloudHandler;
import com.amaze.filemanagerZichongTest.database.CryptHandler;
import com.amaze.filemanagerZichongTest.database.TabHandler;
import com.amaze.filemanagerZichongTest.database.UtilsHandler;
import com.amaze.filemanagerZichongTest.database.models.CloudEntry;
import com.amaze.filemanagerZichongTest.database.models.OperationData;
import com.amaze.filemanagerZichongTest.database.models.Tab;
import com.amaze.filemanagerZichongTest.exceptions.CloudPluginException;
...
import com.amaze.filemanagerZichongTest.filesystem.PasteHelper;
import com.amaze.filemanagerZichongTest.filesystem.RootHelper;
import com.amaze.filemanagerZichongTest.filesystem.usb.SingletonUsbOtg;
import com.amaze.filemanagerZichongTest.filesystem.ssh.CustomSshJConfig;
import com.amaze.filemanagerZichongTest.filesystem.ssh.SshConnectionPool;
import com.amaze.filemanagerZichongTest.filesystem.usb.UsbOtgRepresentation;
import com.amaze.filemanagerZichongTest.fragments.AppsListFragment;
import com.amaze.filemanagerZichongTest.fragments.CloudSheetFragment;
import com.amaze.filemanagerZichongTest.fragments.CloudSheetFragment.CloudConnectionCallbacks;
import com.amaze.filemanagerZichongTest.fragments.CompressedExplorerFragment;
//import com.example.dynamicftp.FtpServerFragment;
import com.amaze.filemanagerZichongTest.fragments.MainFragment;
import com.amaze.filemanagerZichongTest.fragments.ProcessViewerFragment;
import com.amaze.filemanagerZichongTest.fragments.SearchWorkerFragment;
import com.amaze.filemanagerZichongTest.fragments.TabFragment;
...
import com.amaze.filemanagerZichongTest.ui.dialogs.GeneralDialogCreation;
import com.amaze.filemanagerZichongTest.ui.dialogs.RenameBookmark;
import com.amaze.filemanagerZichongTest.ui.dialogs.RenameBookmark.BookmarkCallback;
import com.amaze.filemanagerZichongTest.ui.dialogs.SftpConnectDialog;
import com.amaze.filemanagerZichongTest.ui.dialogs.SmbConnectDialog;
import com.amaze.filemanagerZichongTest.ui.dialogs.SmbConnectDialog.SmbConnectionListener;
import com.amaze.filemanagerZichongTest.ui.views.appbar.AppBar;
import com.amaze.filemanagerZichongTest.ui.views.drawer.Drawer;
import com.amaze.filemanagerZichongTest.utils.BookSorter;
import com.amaze.filemanagerZichongTest.utils.DataUtils;
import com.amaze.filemanagerZichongTest.utils.DataUtils.DataChangeListener;
import com.amaze.filemanagerZichongTest.utils.MainActivityHelper;
import com.amaze.filemanagerZichongTest.utils.OTGUtil;
...
import com.amaze.filemanagerZichongTest.utils.files.FileUtils;
...
import static com.amaze.filemanagerZichongTest.fragments.preference_fragments.PreferencesConstants.PREFERENCE_BOOKMARKS_ADDED;
import static com.amaze.filemanagerZichongTest.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORED_NAVIGATION;
import static com.amaze.filemanagerZichongTest.fragments.preference_fragments.PreferencesConstants.PREFERENCE_NEED_TO_SET_HOME;
import static com.amaze.filemanagerZichongTest.fragments.preference_fragments.PreferencesConstants.PREFERENCE_VIEW;
...
public class MainActivity extends PermissionsActivity implements SmbConnectionListener,
    ...
    public static final String CLOUD_AUTHENTICATOR_REDIRECT_URI = "com.amaze.filemanagerZichongTest:/auth";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        * */
        ...
        intentFilter.addAction("com.amaze.filemanagerZichongTest.debug.LOW_STORAGE");
        lowStoragereceiver = new LowStoragereceiver();
        registerReceiver(lowStoragereceiver, intentFilter);
        Intent startIntent = new Intent(this, LowStorageService.class);
                ...
                if (savedInstanceState == null) {
                    if (openProcesses) {
                        ...
                        if(mainActivity.manager.getInstalledModules().contains(ftpModel)){
                            ...
                            Log.d(mainActivity.getApplicationContext().getPackageName(), "zichongtest");
                            intent.setClassName(mainActivity.getApplicationContext().getPackageName(), ftpClass);
    ...
    public void onBackPressed() {
        ...
        } else if (fragment instanceof CompressedExplorerFragment /*FtpServerFragment*/) {
    ...
    protected void onDestroy() {
        ...
        Intent stopIntent = new Intent(this, LowStorageService.class);
    ...
    private void launchAcitivity(String className) {
        ...
        //intent.setClassName(this.getContext().getPackageName(), "com.example.dynamicfeature.AboutActivity");
    ...
    void readSDCard() {
        ...
        if(Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            Log.d("storage", "block大小:"+ blockSize+",block数目:"+ blockCount+",总大小:"+blockSize*blockCount/1024+"KB");
            Log.d("storage", "可用的block数目：:"+ availCount+",剩余空间:"+ availCount*blockSize/1024+"KB");
        }
    }
    ...
    void readSystem() {
        ...
        long availCount = sf.getAvailableBlocksLong();
        Log.d("storage", "block大小:"+ blockSize+",block数目:"+ blockCount+",总大小:"+blockSize*blockCount/1024+"KB");
        Log.d("storage", "可用的block数目：:"+ availCount+",可用大小:"+ availCount*blockSize/1024+"KB");
    }

    private IntentFilter intentFilter;
    private LowStoragereceiver lowStoragereceiver;

    class LowStoragereceiver extends BroadcastReceiver{
        @Override
        public void onReceive(Context context, Intent intent){
            Log.d("SelfAdaptive", "UninstallAll");
