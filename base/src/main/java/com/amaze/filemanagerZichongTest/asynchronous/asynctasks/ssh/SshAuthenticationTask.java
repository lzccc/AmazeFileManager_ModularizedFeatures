...
package com.amaze.filemanagerZichongTest.asynchronous.asynctasks.ssh;
...
import static com.amaze.filemanagerZichongTest.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT;

/**
 * {@link AsyncTask} for authenticating with SSH server to verify if parameters are correct.
 *
 * Used by {@link com.amaze.filemanagerZichongTest.ui.dialogs.SftpConnectDialog}.
 *
 * @see SSHClient
 * @see SSHClient#authPassword(String, String)
 * @see SSHClient#authPublickey(String, KeyProvider...)
 * @see com.amaze.filemanagerZichongTest.ui.dialogs.SftpConnectDialog#authenticateAndSaveSetup(String, String, int, String, String, String, String, KeyPair, boolean)
 * @see com.amaze.filemanagerZichongTest.filesystem.ssh.SshConnectionPool#create(Uri)
 */
