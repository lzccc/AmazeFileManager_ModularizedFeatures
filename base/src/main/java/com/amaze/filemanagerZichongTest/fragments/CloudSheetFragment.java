...
import com.amaze.filemanagerZichongTest.ui.dialogs.SmbSearchDialog;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.linear_layout_get_cloud:
                ...
                cloudPluginIntent.setData(Uri.parse("market://details?id=com.filemanagerZichongTest.amazecloud"));
