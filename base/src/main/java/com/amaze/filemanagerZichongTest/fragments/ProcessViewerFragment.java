...
public class ProcessViewerFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if(mainActivity.manager.getInstalledModules().contains(encryptModel)){
            Intent intent3 = new Intent();
            intent.setClassName(this.getContext().getPackageName(), className);
        ...
        if(mainActivity.manager.getInstalledModules().contains(encryptModel)){
            Intent intent3 = new Intent();
            intent.setClassName(this.getContext().getPackageName(), classNameDe);
            getActivity().bindService(intent3, mDecryptConnection, 0);
        }
    ...
    private void setupDrawables(int serviceType, boolean isMove) {
        switch (serviceType) {
            ...
            case SERVICE_ENCRYPT:
                ...
                cancelBroadcast(new Intent(TAG_BROADCAST_CRYPT_CANCEL));
                break;
