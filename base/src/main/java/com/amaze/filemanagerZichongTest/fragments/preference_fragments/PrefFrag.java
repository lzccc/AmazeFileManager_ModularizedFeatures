...
package com.amaze.filemanagerZichongTest.fragments.preference_fragments;
...
import com.amaze.filemanagerZichongTest.ui.views.preference.CheckBox;
...
import static com.amaze.filemanagerZichongTest.R.string.feedback;
import static com.amaze.filemanagerZichongTest.activities.PreferencesActivity.START_PREFERENCE;
...
public class PrefFrag extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    private final String aboutActivity = "DynamicAbout";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        manager = SplitInstallManagerFactory.create(this.getContext());
            ...
            for (String module: state.moduleNames()) {
                switch (state.status()) {
                    ...
                    case SplitInstallSessionStatus.REQUIRES_USER_CONFIRMATION:
                        try {
                            activity.startIntentSender(state.resolutionIntent().getIntentSender(), null, 0,0,0);
    ...
    private void launchAcitivity(String className) {
        Log.d("MainA", "Zichong");
        Log.d("MainA", this.getContext().getPackageName());
