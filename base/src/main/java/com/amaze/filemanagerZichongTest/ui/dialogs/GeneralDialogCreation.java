 ...
 */
package com.amaze.filemanagerZichongTest.ui.dialogs;

import static android.os.Build.VERSION_CODES.M;
import static com.amaze.filemanagerZichongTest.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SORTBY_ONLY_THIS;
import static com.amaze.filemanagerZichongTest.utils.files.FileUtils.toHybridFileArrayList;
...
import com.amaze.filemanagerZichongTest.adapters.HiddenAdapter;
import com.amaze.filemanagerZichongTest.adapters.data.LayoutElementParcelable;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.CountItemsOrAndSizeTask;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.GenerateHashesTask;
import com.amaze.filemanagerZichongTest.asynchronous.asynctasks.LoadFolderSpaceDataTask;
//import com.amaze.filemanagerZichongTest.asynchronous.services.EncryptService;
import com.amaze.filemanagerZichongTest.database.SortHandler;
import com.amaze.filemanagerZichongTest.database.models.Sort;
import com.amaze.filemanagerZichongTest.exceptions.ShellNotRunningException;
...
import com.amaze.filemanagerZichongTest.filesystem.compressed.CompressedHelper;
...
import com.amaze.filemanagerZichongTest.ui.views.WarnableTextInputLayout;
...
import com.amaze.filemanagerZichongTest.utils.FingerprintHandler;
import com.amaze.filemanagerZichongTest.utils.OpenMode;
import com.amaze.filemanagerZichongTest.utils.RootUtils;
import com.amaze.filemanagerZichongTest.utils.SimpleTextWatcher;
...
public class GeneralDialogCreation {
    ...
    static final String TAG_SOURCE = "crypt_source";     // source file to encrypt or decrypt
    static final String TAG_ENCRYPT_TARGET = "crypt_target"; //name of encrypted file
    static final String TAG_DECRYPT_PATH = "decrypt_path";
    static final String TAG_OPEN_MODE = "open_mode";
    ...
    public static void showEncryptWithPresetPasswordSaveAsDialog(@NonNull final Context c, @NonNull final MainActivity main, @NonNull String password, @NonNull final Intent intent) {
        ...
        HybridFileParcelable intentParcelable = intent.getParcelableExtra(TAG_SOURCE);
        MaterialDialog saveAsDialog = showNameDialog(main,
                ...
                (dialog, which) -> {
                    ...
                    intent.putExtra(TAG_ENCRYPT_TARGET, textfield.getText().toString());
                    try {
