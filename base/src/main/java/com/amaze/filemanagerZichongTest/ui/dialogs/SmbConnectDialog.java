...
import com.amaze.filemanagerZichongTest.utils.EditTextColorStateUtil;
import com.amaze.filemanagerZichongTest.utils.SimpleTextWatcher;
import com.amaze.filemanagerZichongTest.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.amaze.filemanagerZichongTest.database.UtilsHandler#removeSmbPath(String, String)}
         */
