package com.amaze.filemanagerZichongTest.utils.files;
...
//import com.amaze.filemanagerZichongTest.asynchronous.services.DecryptService;
...
public class EncryptDecryptUtils {
    ...
    public static void startEncryption(Context c, final String path, final String password,
        ...
        String destPath = path.substring(0, path.lastIndexOf('/')+1)
                .concat(intent.getStringExtra(TAG_ENCRYPT_TARGET));
    ...
    static Intent decryptInt;
    public static void passIntent(Intent intent){
        decryptInt = intent;
    }
    ...
    public static void decryptFile(Context c, final MainActivity mainActivity, final MainFragment main, OpenMode openMode,
        ...
        Intent decryptIntent = decryptInt;
        decryptIntent.putExtra(TAG_OPEN_MODE, openMode.ordinal());
        decryptIntent.putExtra(TAG_SOURCE, sourceFile);
        decryptIntent.putExtra(TAG_DECRYPT_PATH, decryptPath);
